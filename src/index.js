// trying to run checkIfPair() method on both entries of memoryGame.pickedCards + when 2 cards are clicked turn them back
...
card.classList.add('turned')
    ...
    //  use push method to push the cards into an array and use the method
